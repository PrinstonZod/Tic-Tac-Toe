...
public class FourByFourGameplayActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler();
        setContentView(R.layout.activity_four_by_four_gameplay);
    ...
    public boolean checkForWin() {
        resetStrings();
        if (strings[0][0].equals(strings[0][1]) && strings[0][0].equals(strings[0][2]) && strings[0][0].equals(strings[0][3]) && !strings[0][0].equals("")) {
            return true;
        }
        if (strings[1][0].equals(strings[1][1]) && strings[1][0].equals(strings[1][2]) && strings[1][0].equals(strings[1][3]) && !strings[1][0].equals("")) {
            return true;
        }
        if (strings[2][0].equals(strings[2][1]) && strings[2][0].equals(strings[2][2]) && strings[2][0].equals(strings[2][3]) && !strings[2][0].equals("")) {
            return true;
        }
        if (strings[3][0].equals(strings[3][1]) && strings[3][0].equals(strings[3][2]) && strings[3][0].equals(strings[3][3]) && !strings[3][0].equals("")) {
            return true;
        }


        if (strings[0][0].equals(strings[1][0]) && strings[0][0].equals(strings[2][0]) && strings[0][0].equals(strings[3][0]) && !strings[0][0].equals("")) {
            return true;
        }
        if (strings[0][1].equals(strings[1][1]) && strings[0][1].equals(strings[2][1]) && strings[0][1].equals(strings[3][1]) && !strings[0][1].equals("")) {
            return true;
        }
        if (strings[0][2].equals(strings[1][2]) && strings[0][2].equals(strings[2][2]) && strings[0][2].equals(strings[3][2]) && !strings[0][2].equals("")) {
            return true;
        }
        if (strings[0][3].equals(strings[1][3]) && strings[0][3].equals(strings[2][3]) && strings[0][3].equals(strings[3][3]) && !strings[0][3].equals("")) {
            return true;
        }


        if (strings[0][0].equals(strings[1][1]) && strings[0][0].equals(strings[2][2]) && strings[0][0].equals(strings[3][3]) && !strings[0][0].equals("")) {
            return true;
        }
        if (strings[0][3].equals(strings[1][2]) && strings[0][3].equals(strings[2][1]) && strings[0][3].equals(strings[3][0]) && !strings[0][3].equals("")) {
            return true;
        }
        return false;
    }
    ...
    class MyAI {
        ...
        public MyAI(long seed) {
            gen = new Random(seed);
        }

        // a clone button.onClick for AI since you know...AI aint got fingers yet to click button... not yet anyway
            ...
            for (int i = 0; i < 4; i++)
                for (int j = 0; j < 4; j++) {
                    ...
                    if (3 - i == j) {
                        ...
                        for (int k = 0; k < 4; k++) {
                            //check the diagonal to get number of opposing/supporting cells
                            if (strings[3 - k][k].equals(comLetter)) supporting++;
                            else if (!strings[3 - k][k].equals("")) opposing++;
                        }
                        //a mixed up diagonal is useless;
                    ...
                    danger += maxhelp;
                    Log.i("Cell " + ((Integer) (i * 10 + j)).toString(), "Danger " + ((Integer) danger).toString());
